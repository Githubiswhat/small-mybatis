...
public class UnpooledDataSource implements DataSource {
    ...
    private static Map<String, Driver> registeredDriver = new ConcurrentHashMap<>();
    ...
    static {
        ...
        while (drivers.hasMoreElements()){
            ...
            registeredDriver.put(driver.getClass().getName(), driver);
        }
    }
    ...
    private static class DriverProxy implements Driver{
        ...
        public DriverProxy(Driver realDriver) {
    ...
    private void initializeDriver() {
        if (!registeredDriver.containsKey(driverClassName)){
            try {
                Class<?> driverType = Class.forName(driverClassName, true, driverClassLoader);
                Driver driverInstance = (Driver) driverType.newInstance();
                DriverManager.registerDriver(new DriverProxy(driverInstance));
                registeredDriver.put(driverClassName, driverInstance);
    ...
    public <T> T unwrap(Class<T> iface) throws SQLException {
        throw new SQLException(getClass().getName() + " is not a wrap");
    }
